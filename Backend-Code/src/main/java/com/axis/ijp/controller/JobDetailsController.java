...
public class JobDetailsController {
	...
	/**
	 * Create Job Details. Author: Utkarsha Bhosale
	 */
	...
	/**
	 * View all Job Details. Author: Utkarsha Bhosale
	 */
	...
	/**
	 * View Job by ID. Author: Utkarsha Bhosale
	 */
	...
	/**
	 * Update Job Details. Author: Utkarsha Bhosale
	 */
	...
	/**
	 * Delete Job Details. Author: Utkarsha Bhosale
	 */
	@DeleteMapping("/{jobId}")
	@PreAuthorize("hasAuthority('ROLE_HR')")
